...
bookmarksRouter
  ...
  .post(bodyParser, (req, res, next) => {
    ...
    if (!Number.parseInt(newBookmark.rating) || parseInt(newBookmark.rating) < 0 || parseInt(newBookmark.rating) > 5) {
      logger.error(`Invalid rating '${newBookmark.rating}' supplied`)
